...
const variantClasses: Record<ButtonVariant, string> = {
  link: 'text-body-15-medium font-medium text-accent underline-offset-2 hover:text-accent-hover hover:underline dark:text-accent dark:hover:text-accent-hover',
