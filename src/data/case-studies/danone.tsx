        ...
        items: [
          {
            variant: 'positive',
            title: '150%',
            description: isPt ? 'Aumento no tráfego do site' : 'Increase in site traffic',
          },
          {
            variant: 'positive',
            title: '20+',
            description: isPt ? 'Componentes reutilizáveis criados' : 'Reusable components built',
          },
          {
            variant: 'positive',
            title: '10+',
            description: isPt ? 'Templates de página criados' : 'Page templates created',
          },
        ],
        disclaimer: isPt
        ...
        body: (
          <>
            ...
            <ul className="list-disc pl-5 space-y-2">
              <li>
                <strong>{isPt ? 'Discovery e Pesquisa:' : 'Discovery &amp; Research:'}</strong>{' '}
                {isPt
              ...
              <li>
                <strong>{isPt ? 'Desenvolvimento de Proto-Personas:' : 'Proto-Persona Development:'}</strong>{' '}
                {isPt
              ...
              <li>
                <strong>{isPt ? 'Arquitetura da Informação:' : 'Information Architecture:'}</strong>{' '}
                {isPt
      ...
      },
      {
        ...
        images: [
          ...
          },
          {
            ...
            alt: isPt
              ? 'Biblioteca de componentes da Danone: grade de produtos e imagens de marca'
              : 'Danone component library: product grid and brand imagery',
          },
          {
            src: `${IMG_BASE}/grid1-3.png`,
            alt: isPt
              ? 'Biblioteca de componentes da Danone: cards de conteúdo e padrões de navegação'
              : 'Danone component library: content cards and navigation patterns',
          },
          {
            src: `${IMG_BASE}/grid1-4.png`,
            alt: isPt
              ? 'Biblioteca de componentes da Danone: exemplos de layout responsivo'
              : 'Danone component library: responsive layout examples',
          },
        ],
      },
      {
      ...
      
      {
        ...
        images: [
          ...
          },
          {
            ...
            alt: isPt
              ? 'Identidade visual da Danone: exemplos responsivos em mobile'
              : 'Danone visual identity: mobile-responsive page examples',
          },
          {
            src: `${IMG_BASE}/grid2-4.png`,
            alt: isPt
              ? 'Identidade visual da Danone: hero com criança e alimentos saudáveis'
              : 'Danone visual identity: hero banner with child and healthy food imagery',
          },
        ],
      },
      {
