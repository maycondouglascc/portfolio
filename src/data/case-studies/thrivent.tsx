    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          {
            variant: 'negative',
            title: isPt ? 'Anos de drift acumulado' : 'Years of accumulated drift',
            description: isPt
      ...
      },
      {
        ...
        steps: [
          ...
          {
            label: isPt ? 'Padronização de componentes' : 'Component standardization',
            description: isPt
          ...
          {
            label: isPt ? 'Consolidação e documentação' : 'Consolidation & documentation',
            description: isPt
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>{isPt ? 'O fluxo ficou assim:' : 'The flow worked like this:'}</p>
      ...
      },
      {
        ...
        body: (
          <>
            ...
            <p>{isPt ? 'Alguns exemplos encontrados:' : 'Some examples found:'}</p>
      ...
      },
      {
        ...
        images: [
          ...
          },
          {
            ...
            alt: isPt ? 'Variações do componente card' : 'Card component variations',
          },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          {
            variant: 'positive',
            title: isPt ? 'Documentação que agentes usam' : 'Documentation agents can use',
            description: isPt
